...
The function \code{gof} accepts an \code{object} of class \code{hergm} as argument and assesses the goodness-of-fit of the model estimated by function \code{hergm}.
