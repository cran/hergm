...
hergm.wrapper <- function(seed, hergm_list) 
{
  ...
  if (hergm_list$simulate == TRUE)
    ...
    as.integer(hergm_list$null$alpha_shape),
    as.integer(hergm_list$null$alpha_rate),
    as.integer(hergm_list$null$alpha),
    as.integer(hergm_list$null$eta_mean_mean),
    as.integer(hergm_list$null$eta_mean_precision),
    as.integer(hergm_list$null$eta_precision_shape),
    as.integer(hergm_list$null$eta_precision_rate),
    as.integer(hergm_list$null$eta_mean),
    as.integer(hergm_list$null$eta_precision),
